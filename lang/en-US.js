export default {
  ...
  about: {
    ...
    <a href="https://redirectioneaza.ro">redirectioneaza.ro</a> and many others.</p>`,
    p1: 'This solution was prototyped in:',
    p2: 'developed pro-bono by:',
    p3: 'in partnership with:',
  },
  map_text: `<p class="font-weight-bold m-0">This is where you’ll soon be able to find a map with a search form that will help you locate the polling place you are assigned to. This is a project we developed completely Pro Bono. If we helped you here, consider making <a
