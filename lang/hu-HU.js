export default {
  ...
  rel="noopener noreferrer">donație oricât de mică</a> pentru Code for Romania care a dezvoltat acest site complet pro bono.</p>`,
    ...
    <p>A cookie olyan információkat tartalmaz, amelyek a felhasználókat egy adott webhelyhez kapcsolják. Ha egy böngésző újra hozzáfér az adott webszerverhez, elolvassa a már tárolt információkat, és ennek megfelelően reagál.</p>
    <h2>Mennyi a süti élettartama?</h2>
    <p>Vannak olyan cookie-k, amelyeket kizárólag egyetlen munkamenethez használnak – ezeket már nem őrizzük meg, miután a felhasználó elhagyta a weboldalt. Állandó sütik – minden alkalommal megmaradnak és újra felhasználásra kerülnek, amikor a felhasználó visszatér az adott weboldalra, de a felhasználó bármikor törölheti őket.</p>
    ...
    <p>Amikor regisztrál ezen a webhelyen, létrehozunk egy cookie-t a rajta lévő adatokkal. A süti segít nekünk a következő lépésekben a szerverrel való kommunikációban. Megmaradhat, ha nem hajtja végre a regisztráció összes lépését, de a következő regisztráció során újraírja.</p>
    <h2>Egyéb harmadik féltől származó sütik</h2>
    <p>Egyes oldalakon harmadik felek beállíthatnak saját névtelen sütiket az alkalmazás sikerének nyomon követése vagy az alkalmazás testreszabása érdekében. Ennek a webhelynek a használata miatt ez a webhely nem férhet hozzá ezekhez a sütikhez, ahogyan harmadik felek sem férhetnek hozzá a webhely által tárolt sütikhez. Például, ha megoszt egy oldalt a webhelyen található közösségi média gomb használatával, az a közösségi hálózat rögzíti tevékenységét.</p>
