export default {
  ...
  about: {
    ...
    p1: 'Megoldás tervezése:',
    p2: 'pro bono fejlesztés:',
    p3: 'partnerek:',
  },
  info_text:
    '2020 december 6-án parlamenti választások lesznek Romániában. Azok az állampolgárok melyek külföldön élnek, vagy melyek külföldön vannak átmenetben a választások időpontjakor nem tudjak kifejezni szavazatukat, ezt csak azoknak az állampolgároknak lehetséges melyek Románia területén tartózkodnak és abban a szavazókörzetben ahová címüktől függően ki vannak osztva. Ha vannak rokonaid az országban, bátorítsd őket hogy használják a Vot Romania-t hogy pontosan megtudják milyen körülmények között szavazhatnak, milyen dokumentumokra lesz szükségük és hol találhatók a szavazóirodák.',
  map_text: `<p class=“font-weight-bold m-0”>Hamarosan itt találhatsz egy térképet és egy keresőgombot melyek segíteni fognak hogy megtaláld a szavazóíródádat<br/> Ha a Vot România segít, tegyél egy <a
      href=“https://code4.ro/ro/doneaza/”
      target=“_blank”
      rel=“noopener noreferrer”>bármilyen kis adományt </a> a Code for Romania -nak aki pro bono fejlesztette ezt a webhelyet</p>`,
  temp_text:
    'A jelenlegi szavazóirodás térkép a 2019 Államelnöki választáskor szervezett szavazóirodák térképe. Ezt frissítjük amint az új adatok elérhetők lesznek. A határidő meddig ay Állandó Szavazó Bizottság át kell küldje a Belügyminisztériumnak a külföldön szervezett szavazóirodák listáját szeptember 25, 2020 ',
  social_share: {
  ...
  cookie: {
    ...
    text: `<p>Ez a weboldal sütiket használ, hogy a látogatók számára sokkal jobb böngészési élményt és szolgáltatásokat nyújtson, amelyek igazodnak mindannyiunk egyéni igényeihez és érdekeihez.</p>
      <p>A sütik célja, hogy megkönnyítsék az internet-felhasználók által igénybe vett szolgáltatásokhoz való hozzáférést, például bizonyos beállítások személyre szabását (nyelv, ország, a nemzeti pénznemben megjelenített árak). A sütik a felhasználókról gyűjtött információk alapján segítenek a webhelytulajdonosoknak észszerűsíteni termékeiket, hogy azok könnyen hozzáférhetőek legyenek a felhasználók számára. Emelik az online hirdetések hatékonyságát, és nem utolsósorban multimédiás vagy más alkalmazásokat is engedélyezhetnek más webhelyeken. Fel kell venni egy adott webhelyre, hogy a navigáció hasznosabb legyen.</p>
      <h2>Mi az a süti?</h2>
      <p>A Cookie (böngésző süti vagy HTTP cookie) egy kis betűkből és számokból álló fájl, amelyet minden internet-hozzáféréssel rendelkező terminálon (számítógép, mobiltelefon, táblagép stb.) tárolnak, és amelyet egy böngésző web-szervere ér el (pl .: Internet Explorer, Chrome). Kérjük, vegye figyelembe: A sütik nem tartalmaznak szoftvert, vírusokat vagy kémprogramokat, és nem férhetnek hozzá a felhasználó merevlemezén található információkhoz</p>
      <p>A süti névből és tartalomból áll, annak időtartamát meghatározva, és a webszerver akkor érheti el újra, amikor a felhasználó visszatér az adott webszerverhez társított webhelyre.</p>
      <p>A sütik nem kérnek személyes adatokat, és nem azonosítják személyesen az internet-felhasználókat.</p>
      <p>Munkamenet-sütik – ezeket ideiglenesen a böngésző előzményei tárolják, és addig tárolják őket, amíg a felhasználó nem jelentkezik ki az adott webhelyről, vagy bezárja a böngészőablakot.</p>
      <p>Állandó sütik – ezeket az alapértelmezett időtől függően a számítógép vagy a berendezés merevlemezén tárolják. Az állandó sütik közé tartoznak azok a weboldalak is, amelyeket a felhasználó jelenleg nem látogat el, más néven harmadik fél cookie-k, amelyek névtelenül felhasználhatók a felhasználó érdekeinek tárolására, hogy a lehető legrelevánsabb hirdetést juttassák el a felhasználókhoz.</p>
      <h2>Milyen előnyei vannak a sütiknek?</h2>
      <p>A cookie olyan információkat tartalmaz, amelyek a felhasználókat egy adott webhelyhez kapcsolják. Ha egy böngésző újra hozzáfér az adott webszerverhez, elolvassa a már tár'Olt' információkat, és ennek megfelelően reagál.</p>
      <h2>Mennyi a süti élettartama?</h2>
      <p>Vannak olyan cookie-k, amelyeket kizárólag egyetlen munkamenethez használnak – ezeket már nem őrizzük meg, miután a felhasználó elhagyta a weboldalt. Állandó sütik – minden alkalommal megm'Arad'nak és újra felhasználásra kerülnek, amikor a felhasználó visszatér az adott weboldalra, de a felhasználó bármikor törölheti őket.</p>
      <h2>Mik a harmadik féltől elhelyezett sütik?</h2>
      <p>A tartalom vagy a szolgáltatások egy részét fel lehet tenni a weboldalra, amelyhez harmadik felek bannerek, dobozok vagy linkek révén jutnak hozzá – és minden ilyen eszköz tartalmazhat sütiket. Harmadik fél sütinek hívják őket, mert nem az adott weboldal tulajdonosa helyezi el őket, a harmadik fél szolgáltatóira pedig a hatályos törvények és a webhely tulajdonosának adatvédelmi irányelvei vonatkoznak.</p>
      <h2>Hogyan használják a sütik a webhelyet?</h2>
      <p>Ennek a webhelynek a meglátogatása sütiket helyezhet el:</p>
      <ul>
        <li>Az adomány teljesítéséhez használt sütik</li>
        <li>Látogatóelemző sütik</li>
        <li>Regisztrációs sütik</li>
        <li>Egyes sütik harmadik felektől származhatnak.</li>
      </ul>
      <h2>Az adomány teljesítéséhez használt sütik'</h2>
      <p>Az adományozási űrlap kitöltése több lépést tartalmaz. A személyek nyomon követése és a szükséges dokumentumok rendelkezésre bocsátása érdekében elmentünk egy cookie fájlt, amely módszert biztosít a személy azonosítására (például sorozatszámot). Az űrlap minden kitöltése esetén új süti jön létre, vagy a meglévő felülírásra kerül.</p>
      <h2>Sütik a látogatók elemzéséhez</h2>
      <p>Minden alkalommal, amikor a felhasználó meglátogatja ezt a webhelyet, a harmadik fél által biztosított elemző szoftver létrehoz egy felhasználói elemzési sütit. Ez a süti megmondja nekünk, hogy járt-e már ezen a webhelyen. A böngésző megmondja nekünk, hogy Ön rendelkezik-e ezzel a sütivel, és ha nem, akkor mi létrehozunk egyet. Lehetővé teszi azon egyedi felhasználók megfigyelését, akik felkeresnek minket, hogy milyen gyakran csinálják. Ez a süti nem használható az egyének azonosítására, csak statisztikai célokra használják.</p>
      <h2>Sütik regisztrációhoz</h2>
      <p>Amikor regisztrál ezen a webhelyen, létrehozunk egy cookie-t a rajta lévő adatokkal. A süti segít nekünk a következő lépésekben a szerverrel való kommunikációban. Megm'Arad'hat, ha nem hajtja végre a regisztráció összes lépését, de a következő regisztráció során újraírja.</p>
      <h2>Egyéb harmadik féltől származó sütik</h2>
      <p>Egyes oldalakon harmadik felek beállíthatnak saját névtelen sütiket az alkalmazás sikerének nyomon követése vagy az alkalmazás testreszabása érdekében. Ennek a webhelynek a használata miatt ez a webhely nem férhet hozzá ezekhez a sütikhez, ahogyan harmadik felek sem férhetnek hozzá a webhely által tár'Olt' sütikhez. Például, ha megoszt egy oldalt a webhelyen található közösségi média gomb használatával, az a közösségi hálózat rögzíti tevékenységét.</p>
      <h2>Milyen típusú információkat tárolnak és férnek hozzá a sütik révén?</h2>
      <p>A sütik információkat egy kis szöveges fájlban tárolnak, amely lehetővé teszi a weboldal számára a böngésző felismerését. A webszerver addig ismeri fel a böngészőt, amíg a cookie lejár, vagy törlődik. A süti fontos információkat tárol, amelyek javítják az internetes böngészés élményét (pl. Adományának sorszáma).</p>
      <h2>Miért fontosak a sütik az internet számára?</h2>
      <p>A sütik jelentik az Internet hatékony működésének központi pontját, elősegítve a barátságos böngészési élményt és az egyes felhasználók preferenciáihoz és érdekeihez igazodva. A sütik elutasítása vagy letiltása egyes webhelyek használatát lehetetlenné teheti. A sütik elutasítása vagy letiltása nem azt jelenti, hogy többé nem kap online hirdetést – hanem csak azt, hogy a továbbiakban nem fogja tudni figyelembe venni az Ön preferenciáit és érdeklődési körét, amelyet a böngészési viselkedése kiemel.</p>
      <p>A cookie-k letiltása és elutasítása bizonyos webhelyeket nem praktikussá vagy nehezen látogathatóvá és használhatóvá tehet. Ezenkívül a sütik elfogadásának elutasítása nem jelenti azt, hogy többé nem fog kapni/látni online hirdetést.</p>
      <h2>Biztonsági és adatvédelmi kérdések</h2>
      <p>A sütik NEM vírusok! Sima szöveges formátumokat használnak. Nem kódrészekből állnak, így nem futtathatók és nem futtathatók automatikusan. Következésképpen nem másolhatók vagy másolhatók más hálózatokon, hogy újra fussanak vagy replikálódjanak. Mivel nem tudják elvégezni ezeket a funkciókat, nem tekinthetők vírusoknak.</p>
      <p>A sütik azonban negatív célokra is felhasználhatók. Mivel a felhasználók preferenciáiról és böngészési előzményeiről információkat tárol, mind egy adott, mind több más webhelyen, a sütik a Spyware egyik formájaként használhatók. Számos kémprogram-elhárító termék tisztában van ezzel, és folyamatosan jelöli a törölni kívánt sütiket a vírusirtó/kémprogram-eltávolító/-ellenőrző eljárások során.</p>
      ...
      <h2>A sütikkel kapcsolatos egyéb biztonsági kérdések</h2>
      <p>Mivel a személyazonosság-védelem nagyon értékes és minden internet-felhasználó jogát képviseli, tanácsos tudni, hogy a cookie-k milyen lehetséges problémákat okozhatnak. Mivel rajtuk keresztül az információkat folyamatosan továbbítják mindkét irányba a böngésző és a weboldal között, ha egy támadó vagy illetéktelen személy beavatkozik az adatátvitel során, a cookie-ban szereplő információkat lehallgathatják. Bár nagyon ritka, ez akkor fordulhat elő, ha a böngésző egy titkosítatlan hálózat (pl. Egy nem biztonságos WiFi hálózat) segítségével csatlakozik a szerverhez.</p>
      <p>Más cookie-alapú támadások helytelen cookie-beállításokkal járnak a szervereken. Ha egy webhely nem követeli meg, hogy a böngésző csak titkosított csatornákat használjon, a támadók ezt a biztonsági rést arra késztethetik, hogy a böngészőket nem biztonságos csatornákon küldjék el az információknak. A támadók ezt követően felhasználják az információkat, hogy jogosulatlanul hozzáférjenek bizonyos webhelyekhez. Nagyon fontos, hogy legyen óvatos a személyes adatok védelmének legmegfelelőbb módjának kiválasztásában.</p>
      <h2>Tippek a biztonságos és felelősségteljes böngészéshez, sütik alapján</h2>
      <p>Rugalmasságuknak és annak a ténynek köszönhetően, hogy a legtöbb látogatott és legnagyobb webhely sütiket használ, szinte elkerülhetetlenek. A sütik letiltása nem teszi lehetővé a felhasználó számára a legelterjedtebb és leggyakrabban használt webhelyek, például a Youtube, a Gmail, a Yahoo és mások hozzáférését. Íme néhány tipp, amelyek biztosítják, hogy gond nélkül, de a sütik segítségével navigálhasson:</p>
      <ul>
        <li>Testreszabhatja böngészője beállításait a cookie-k számára, hogy tükrözze az Ön számára a süti biztonságának megfelelő szintjét. Ha nem bánja a sütiket, és csak Ön használja a számítógépet, hosszú lejárati dátumokat állíthat be a böngészési előzmények és a személyes hozzáférési adatok tárolására. Ha megosztja hozzáférését a számítógépéhez, érdemes megfontolnia a böngésző beállítását úgy, hogy minden egyes böngésző bezárásakor törölje az egyes böngészési adatokat. Ez a lehetőség a sütik elhelyezésére szolgáló webhelyek eléréséhez és a látogatással kapcsolatos információk törléséhez a böngészési munkamenet végén.</li>
        <li>Telepítse és folyamatosan frissítse a kémprogram-elhárító alkalmazásokat.</li>
        <li>A kémprogram-észlelő és -megelőző alkalmazások közül sok magában foglalja a webhely-támadások észlelését. Ez megakadályozza, hogy a böngésző olyan webhelyeket érjen el, amelyek kihasználhatják a böngésző sérülékenységeit vagy rosszindulatú szoftvereket tölthetnek le. Győződjön meg arról, hogy böngészője mindig naprakész. A cookie-alapú támadások közül sokat kihasználnak a böngészők régebbi verzióinak gyengeségei.</li>
        <li>A sütik mindenhol megtalálhatók, és nem kerülhetők el, ha az Internet legjobb és legnagyobb – helyi vagy nemzetközi – webhelyeihez szeretne hozzáférést biztosítani. A működésük és az általuk nyújtott előnyök világos megértésével megteheti a szükséges biztonsági intézkedéseket, hogy magabiztosan böngészhessen az interneten.</li>
      </ul>
      <h2>Hogyan állíthatom le a sütiket?</h2>
      <p>A cookie-k letiltása és elutasítása bizonyos webhelyeket nem praktikusakká vagy nehezen látogathatóvá és használatossá teheti. Ezenkívül a sütik elfogadásának elutasítása nem jelenti azt, hogy többé nem fog kapni/látni online hirdetést.</p>
      <p>Lehetőség van a böngészőben úgy beállítani, hogy ezeket a cookie-kat már ne fogadják el, vagy beállíthatja, hogy a böngésző elfogadja egy adott webhely cookie-jait. De például, ha nem akar sütiket használni, akkor a regisztráció után nem követheti a következő lépéseket, kitöltheti az űrlapot.</p>
      <p>Minden modern böngésző lehetővé teszi a cookie-beállítások megváltoztatását. Ezek a beállítások általában a böngésző beállításai vagy beállításai menüben találhatók.</p>
      <p>A harmadik felek által létrehozott sütik beállításaihoz és az online hirdetésekkel kapcsolatos adatvédelemről az IAB Romania a következő webhelyet biztosítja:
